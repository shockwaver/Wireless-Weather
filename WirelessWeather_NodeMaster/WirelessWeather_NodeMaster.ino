...
void printInfo(dataPacket data) {
  ...
  Serial.print("Node ");Serial.print(data.address);Serial.print(" - ");
  Serial.print("Up: ");Serial.print(data.uptime);Serial.print("m, ");
  //Serial.print(data._micros);Serial.print(", ");
  Serial.print(data.temp);Serial.print(", ");
  //Serial.print(dataPackage.chipTemp);Serial.print(", ");
  Serial.print(data.Vcc/100.0);Serial.print("Vcc, ");
  Serial.print(data.Vbat / 100.0);Serial.print("VBat ");
  ...
  Serial.print("(Age: ");Serial.print(millis()/1000 - old_time);Serial.println(" s)");
...
<-TS  1234567890123456789012345678901234567890123456789012 00112233 4455667788990
   ...
   2) 0000100100010010001001111000010100001101101011111000 00000045 091227850DAF8 st:34 ok: 50% RH
                ssiiiiiiii                                                 hh
                                                                          hh - possible shifted back one byte - this example would be 85%RH
                                                                             hh - possible here. AE would be 174 - 100 would be 74%?
    ...
    if( PacketAndChecksum_OK_WS2355 )
    {
      ...
      switch( b )
      {
        ...
        case 3:
        {
          ...
          lacrosse.windDir = bWSR_CurrentWindDirection;
